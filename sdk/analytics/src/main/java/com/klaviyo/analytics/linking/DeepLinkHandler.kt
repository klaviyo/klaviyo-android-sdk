...
object DeepLinking {
    ...
    /** Convenience overload for uri [String] */
    fun handleDeepLink(uri: String) = try {
        handleDeepLink(uri.toUri())
    } catch (e: Exception) {
        Registry.log.error("Could not handle universal link: $uri", e)
    }

    /** Convenience overload for [URL] object */
     ...
     */
    fun sendDeepLinkIntent(uri: Uri) =
