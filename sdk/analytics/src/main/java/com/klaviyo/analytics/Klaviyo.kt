...
object Klaviyo {
     ...
     * @return
     */
    fun setEmail(email: String): Klaviyo = setProfile(Profile().setEmail(email))
    ...
    fun setPhoneNumber(phoneNumber: String): Klaviyo =
        setProfile(Profile().setPhoneNumber(phoneNumber))
     ...
     * @return
     */
    fun setExternalId(id: String): Klaviyo = setProfile(Profile().setExternalId(id))
