...
internal class LifecycleObserver : JsBridgeObserver, ActivityObserver {
    ...
    override fun startObserver() = Registry.lifecycleMonitor.onActivityEvent(this)

    override fun stopObserver() {
        lastBackgrounded = null
        Registry.lifecycleMonitor.offActivityEvent(this)
    }

    override fun invoke(activity: ActivityEvent) {
        when (activity) {
            // App foregrounded
