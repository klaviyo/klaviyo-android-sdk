...
2. Add these dependencies to your app's build file
   ...
   // build.gradle.kts
   dependencies {
       implementation("com.github.klaviyo.klaviyo-android-sdk:analytics:1.2.0")
       implementation("com.github.klaviyo.klaviyo-android-sdk:push-fcm:1.2.0")
   }
   ```
   ```groovy
   // build.gradle
...
Dokka [here](https://klaviyo.github.io/klaviyo-android-sdk/1.2.0)