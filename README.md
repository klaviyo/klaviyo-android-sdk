...
In order for rich push notifications to work on your app, your app needs to be on or above version 1.2.0-beta1 of the Klaviyo SDK

## Code Documentation

Browse complete code documentation autogenerated with
Dokka [here](https://klaviyo.github.io/klaviyo-android-sdk/1.1.1)
