...
In order for rich push notifications to work on your app, your app needs to be on the Klaviyo SDK version 1.2.0.

## Code Documentation

Browse complete code documentation autogenerated with
Dokka [here](https://klaviyo.github.io/klaviyo-android-sdk/1.1.0)