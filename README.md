...
**Note:** We strip whitespace from identifier values, and empty strings will be ignored with a logged warning. 
If you are trying to remove an identifier's value, use `setProfile` or `resetProfile`.
