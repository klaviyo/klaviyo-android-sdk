...
2. Add the dependencies to your app's build file
   <details>
      ...
      // build.gradle.kts
      dependencies {
          implementation("com.github.klaviyo.klaviyo-android-sdk:analytics:3.1.0-alpha.1")
          implementation("com.github.klaviyo.klaviyo-android-sdk:push-fcm:3.1.0-alpha.1")
      }
      ```
   </details>
